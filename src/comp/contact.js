...
function Contact() {
    ...
    const send = async (e) =>
    {
        ...
        const send = await fetch(
            'https://react-app-contact-a7af6-default-rtdb.firebaseio.com/Message.json', option
            )
            ...
            <div className='form'>
                ...
                <form method='POST'>
                    ...
                    <div className='box'>
                        ...
                        <div className='input'>
                            <input type='text' placeholder='Subjet' value={user.subject} name='subjet' onChange={data}></input>
                        </div>
                    </div>
                    <div className='box'>
                        <div className='label'>
